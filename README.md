...
> This module is under active development. While it is already used to power a [handful of sites](https://nuxtify.dev/showcase) in production, expect things to change frequently. I will do my best to call out breaking changes in the [changelog](https://github.com/nuxtify-dev/cms/blob/main/CHANGELOG.md).
...
### [Nuxtify CMS](https://github.com/nuxtify-dev/cms) (this module)

Provides a lightweight, file-based CMS for Nuxt applications.

- Manage content using Markdown, JSON, or YAML
- Integrated with [Nuxt Content](https://content.nuxt.com/) for powerful querying
...
- Page level components, including an easy to customize header and footer
...
Nuxtify CMS builds on the amazing features of [Vue](https://vuejs.org/guide/introduction), [Nuxt](https://nuxt.com/docs/getting-started/introduction), and [Vuetify](https://vuetifyjs.com/en/introduction/why-vuetify/).
...
Add the `@nuxtify/cms` module to `nuxt.config.ts` and configure it:
...
To see the full config, check out the [types](https://github.com/nuxtify-dev/cms/blob/main/src/types/module.ts).
...
```bash
npm update @nuxtify/cms --save
```

**Major versions**

```bash
npm install @nuxtify/cms@latest --save
```
...
- **Reporting Bugs:** If you come across any bugs or issues, please [open a new issue](https://github.com/nuxtify-dev/cms/issues/new).
- **Suggestions:** Have ideas to enhance Nuxtify? I'd love to hear them! You can [open a new issue](https://github.com/nuxtify-dev/cms/issues/new) describing your feature request or suggestion.
...
[MIT](https://github.com/nuxtify-dev/cms/blob/main/LICENSE)

<!-- Badges -->

[npm-version-src]: https://img.shields.io/npm/v/@nuxtify/cms/latest.svg?style=flat&colorA=020420&colorB=00DC82&label=version
[npm-version-href]: https://npmx.dev/package/@nuxtify/cms
[npm-downloads-src]: https://img.shields.io/npm/dm/@nuxtify/cms.svg?style=flat&colorA=020420&colorB=00DC82
[npm-downloads-href]: https://npm.chart.dev/@nuxtify/cms
[license-src]: https://img.shields.io/npm/l/@nuxtify/cms.svg?style=flat&colorA=020420&colorB=00DC82
[license-href]: https://npmx.dev/package/@nuxtify/cms
...
[playground-href]: https://stackblitz.com/github/nuxtify-dev/cms?file=playground%2Fapp.vue
