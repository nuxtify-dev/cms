...
- [Nuxtify CMS](https://github.com/nuxtify-dev/cms) (this module). Provides a lightweight, file-based CMS for Nuxt applications. Extends Nuxtify Pages.
...
Nuxtify CMS builds on the functionality in [Nuxtify Pages](https://github.com/nuxtify-dev/pages).
